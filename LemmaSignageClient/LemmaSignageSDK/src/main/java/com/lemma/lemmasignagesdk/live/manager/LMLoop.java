...
import com.lemma.lemmasignagesdk.vast.VastBuilder.RtBMarkerAdGroup;
...
public class LMLoop {
    ...
    private final LMDeviceInfo deviceInfo;
    private final Integer preFetchRTBCount = 2;
    ...
    public LMLoop(final NetworkStatusMonitor monitor, String rootDirectory,
        ...
        loopAdLoader = new AdLoader(new AdLoader.AdLoaderListener() {
            @Override
    ...
    private void scheduleDeletionIfNeeded(Queue<Vast> vastQ, String path) {
        ...
        if (deleteCacheContinuously || !LMUtils.isDeviceMemoryAvailable(0.1f)) {
