...
public class TrackerDBHandler extends SQLiteOpenHelper {
    ...
    private static final String TAG = "TrackerDBHandler";
    ...
    public void add(String trackerUrl) {
        try {
            ...
            LMLog.e(TAG, "Failed To add entry in DB" + e.getLocalizedMessage());
        }
    }
    ...
    public ArrayList popAll() {
        ...
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_TRACKER + " LIMIT 25";
    ...
    public void deleteRecords(List<Integer> trackerIdList) {
        try {
            ...
            LMLog.e(TAG, "Failed To delete entry in DB" + e.getLocalizedMessage());
        }
