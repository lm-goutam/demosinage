package com.lemma.lemmasignagesdk.views;
...
import com.lemma.lemmasignagesdk.vast.listeners.AdPlayerAdapter;
...
public class AdPlayerView extends FrameLayout {
    ...
    private final String TAG = "AdVideoPlayer";
    public AdI ad;
    ...
    public void loadAd(AdI ad) {
        ...
        if (ad.getType() == AdType.LINEAR) {
            ...
            if (isImageType(ad.mimeType())) {
                ...
                String url = ad.getAdRL();
//                String u = "android.resource://" + getContext().getPackageName() +
//                        "/raw/lemmaad.mp4";
